...
const PasswordShowHideBtn = ({ width, fill, id }) => {
    useEffect(() => {
    ...
    return (
        <>
            <svg id={'PasswordShowIcon-' + id}
                onClick={() => handlePasswordShowHideBtnClick("hide")}
                className='password-show-hide-btn'
                style={{ display: 'none', width: width, height: 'auto', transformStyle: 'preserve-3d' }}
            ...
            >
                ...
                />
                <ellipse id={"eye-" + id} style={{ stroke: fill, fill: fill }} cx="100" cy="400" rx="30" ry="30" />
            </svg>
            <svg id={'PasswordHideIcon-' + id}
                onClick={() => handlePasswordShowHideBtnClick("show")}
                className='password-show-hide-btn'
                style={{ display: 'block', width: width, height: 'auto', transformStyle: 'preserve-3d' }}
                viewBox="295.283 308.794 209.395 182.982"
                xmlns="http://www.w3.org/2000/svg"
            >
                <path
                    style={{ stroke: fill, strokeWidth: '12px', strokeLinecap: 'round', fill: 'rgba(255, 255, 255, 0)' }}
                    d="M 300 400 C 354.851 465.637 442.071 467.372 500 400" />
                <line
                    style={{ fill: 'rgb(216, 216, 216)', stroke: fill, strokeWidth: '12px', strokeLinecap: 'round' }}
