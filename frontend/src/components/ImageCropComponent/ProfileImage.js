...
const ProfileImage = ({ avatar, imgData, fileName, srcPrefix }) => {

    const [profileImageSrc, setProfileImageSrc] = useState(avatar ? imgData.imgData : '')
    ...
    useEffect(() => {
        setProfileImageSrc(imgData.imgData);
    }, [profileImageSrc, imgData.imgData]); // Run the effect whenever profileImageSrc changes
    ...
    async function handelUploadClick() {
        try {
            ...
            imgData.setImgData(canvas.toDataURL('image/jpeg', 1));
            ...
            <div className='profile-img-div'>
                <div className='img'>
                    <img className='profile-img' ref={profileImg}
                        src={fileName && !profileImageSrc ? srcPrefix + fileName + '.jpg' : imgData.imgData ? imgData.imgData : userImg} alt='' loading='lazy' />
