...
const ProfileImage = ({ uploadUrl, avatar, fileName }) => {
    ...
    const [profileImageSrc, setProfileImageSrc] = useState(avatar ? fileName : undefined)
        ...
        <>
            <div className='profile-img-div'>
                <img className='profile-img'
                    src={profileImageSrc ? 'http://localhost:3001/uploads/profile-image/' + profileImageSrc + '.jpg' : userImg}
                    alt='' />
